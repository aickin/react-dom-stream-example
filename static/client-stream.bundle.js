...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDomStream = __webpack_require__(159);

	var _reactDomStream2 = _interopRequireDefault(_reactDomStream);

	var _RecursiveDivs = __webpack_require__(158);

	var _RecursiveDivs2 = _interopRequireDefault(_RecursiveDivs);

	if (window) {
		window.render = function (depth, breadth, hash) {
			_reactDomStream2["default"].render(_react2["default"].createElement(_RecursiveDivs2["default"], { depth: depth, breadth: breadth }), document.getElementById("renderNode"), hash);
		};
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecursiveDivs = (function (_React$Component) {
		...
		function RecursiveDivs() {
			...
			_get(Object.getPrototypeOf(RecursiveDivs.prototype), "constructor", this).apply(this, arguments);
		}
		...
		_createClass(RecursiveDivs, [{
			...
			value: function render() {
				...
				var breadth = _props.breadth;
				var textLength = _props.textLength;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		render: function render(reactElement, domElement, hash) {
